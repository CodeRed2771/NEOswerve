...
public class Calibration {
	...
	*/
	...
	public static final double AUTO_ROT_P = 0.03; // increased from .03 on 2/9/2019 by CS
	public static final double AUTO_ROT_I = 0.003;
	public static final double AUTO_ROT_D = 0.04;  // was 067
