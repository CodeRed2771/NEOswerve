...
public class Calibration {
	...
	private final static double DT_A_ABS_ZERO_INITIAL = .359; // COMPEITION
	private final static double DT_B_ABS_ZERO_INITIAL = .637;
	private final static double DT_C_ABS_ZERO_INITIAL = .679;
