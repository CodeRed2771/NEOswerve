...
public class Calibration {
	...
	private final static double DT_A_ABS_ZERO_INITIAL = .728; // COMPEITION
	private final static double DT_B_ABS_ZERO_INITIAL = .021;
	private final static double DT_C_ABS_ZERO_INITIAL = .425;
