...
public class Calibration {
	...
	private final static double DT_B_ABS_ZERO_INITIAL = .081;
	private final static double DT_C_ABS_ZERO_INITIAL = .032;
	private final static double DT_D_ABS_ZERO_INITIAL = .321;
